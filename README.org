...
*** Production   
    ...
    #+NAME: assets.rb
    #+begin_src ruby :tangle config/initializers/assets.rb :padline no
...
**** New
     ...
     #+NAME: LabelsheetNew
     #+begin_src web :tangle app/views/labelsheets/new.html.erb :padline no
       <%= render 'form' %>
       <br/>
...
*** Layouts
    ...
    #+begin_src web :tangle app/views/layouts/application.html.erb :padline no
      <!DOCTYPE html>
      <html>
        <head>
    ...
    #+NAME: _header.html.erb
    #+begin_src web :tangle app/views/layouts/_header.html.erb :padline no
      <div class="pure-g">
